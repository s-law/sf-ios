...
- (void)setupConstraints {
    ...
    [self.shadowView.leftAnchor constraintEqualToAnchor:self.nameLabel.leftAnchor constant: -5].active = true;
    [self.shadowView.rightAnchor constraintEqualToAnchor:self.nameLabel.rightAnchor constant: 5].active = true;
